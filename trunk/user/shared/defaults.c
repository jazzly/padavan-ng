...
#if defined (APP_DOH)
	{ "doh_enable", "0" },
	{ "doh_server1", "https://blitz.ahadns.com/1:4" },			/* DNS resolvers use 1Hosts (Lite) */
	{ "doh_server2", "https://freedns.controld.com/x-1hosts-lite" },	/* DNS resolvers use 1Hosts (Lite) */
	{ "doh_server3", "https://max.rethinkdns.com/1:AAQCAA==" },		/* DNS resolvers use 1Hosts (Lite) */
	{ "doh_opt1_1", "-4 -d -v" },
